...
exercicio :: IO()
exercicio = putStats ("exercicio.txt")

putStats :: FilePath -> IO ()
putStats inFile = do
     nroLinhas <- contLines (inFile)
     print nroLinhas
     nroPalavras <- contWords (inFile)
     print nroPalavras


contLines :: FilePath -> IO Int
contLines = fmap (length . words) . readFile

contWords :: FilePath -> IO Int
contWords = fmap (length . lines) . readFile
